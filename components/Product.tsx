...
const Raiting = ({ rating }: RatingProps) => {
  return (
    <p className='absolute text-xl font-bold text-yellow-500 top-4 right-6'>
      {rating}
    </p>
  );
};
...
export const Product = ({ data }: ProductProps) => {
  return (
    <div className='relative flex flex-col justify-center h-full p-4 transition-all duration-300 bg-white rounded-lg shadow-lg align-center hover:shadow-xl'>
      <Image
        width={160}
        height={160}
